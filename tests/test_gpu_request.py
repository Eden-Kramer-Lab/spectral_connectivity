...
def test_gpu_request_error_message_format():
    ...
    expected_error = (
        "GPU support was explicitly requested via "
...
def test_gpu_behavior_without_cupy():
    ...
    try:
        ...
        # (The actual modules are already imported, so we can't test
        # the import path directly, but we can verify the error message
        # structure)
        pass
