...
class Connectivity:
    ...
    and noise covariance use minimum phase decomposition [1]_ to decompose
    ...
    def imaginary_coherence(self):
        """The normalized imaginary component of the cross-spectrum [1]_.
    ...
    def canonical_coherence(self, group_labels):
        """Finds the maximal coherence between each combination of groups [1]_.
    ...
    def global_coherence(self, max_rank=1):
        ...
        power at each frequency and time window [1]_.
    ...
    def weighted_phase_lag_index(self):
        ...
        coherency magnitudes as weights [1]_.
    ...
    def debiased_squared_phase_lag_index(self):
        ...
        bias induced by using the magnitude of the complex cross-spectrum [1]_.
    ...
    def pairwise_spectral_granger_prediction(self):
        ...
        predictive of) the power at other nodes [1]_.
    ...
    def directed_transfer_function(self):
        ...
        influence of other signals on that signal (inflow) [1]_.
    ...
    def partial_directed_coherence(self, keep_cupy=False):
        ...
        strength of coupling to other signals (outflow) [1]_.
    ...
    def direct_directed_transfer_function(self):
        ...
        accounting for the influence of other signals [1]_.
    ...
    def group_delay(
        ...
        """The average time-delay of a broadband signal [1]_.
...
def _estimate_noise_covariance(minimum_phase):
    ...
    of a multivariate autoregressive model (MVAR) [1]_.
...
def _estimate_transfer_function(minimum_phase):
    ...
    function of a multivariate autoregressive model (MVAR) [1]_.
