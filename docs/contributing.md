...
2. Format, lint, and type-check your code with [ruff](https://docs.astral.sh/ruff/) and [mypy](https://mypy-lang.org/) (the same checks CI runs): `ruff format src/ tests/`, `ruff check src/ tests/`, and `mypy src/`.
